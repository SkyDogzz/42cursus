...
/*   Updated: 2024/12/23 17:46:58 by tstephan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	map->content[pos.y * map->dims.width + pos.x].pos.x = pos.x - dims.width
		/ 2.0 + 0.5;
	map->content[pos.y * map->dims.width + pos.x].pos.y = pos.y - dims.height
		/ 2.0 + 0.5;
	map->content[pos.y * map->dims.width + pos.x].pos.z = ft_atoi(*next)
		/ map->height_div;
